...
INSERT INTO account(first_name, last_name, email, password) 
    VALUES('Darek', 'Halasa', 'darek_halasa@example.com', 'Passw0rd');
INSERT INTO account(first_name, last_name, email, password)
...
INSERT INTO journey(title, description, timestamp)
...
INSERT INTO account_journey(account_id, journey_id)
    VALUES(1, 4);
INSERT INTO account_journey(account_id, journey_id)
    VALUES(2, 5);
INSERT INTO account_journey(account_id, journey_id)
...
INSERT INTO stop(name, date_arrived, date_departed, journey_id)
...
INSERT INTO location(name, date_visited, location_type, stop_id)
...
INSERT INTO review(review_text, score, timestamp)
...
INSERT INTO journey_review(journey_id, review_id, account_id)
    VALUES(1, 1, 1);
INSERT INTO journey_review(journey_id, review_id, account_id)
    VALUES(2, 2, 2);
INSERT INTO journey_review(journey_id, review_id, account_id)
...
INSERT INTO stop_review(stop_id, review_id, account_id)
    VALUES(1, 1, 1);
INSERT INTO stop_review(stop_id, review_id, account_id)
    VALUES(2, 2, 2);
INSERT INTO stop_review(stop_id, review_id, account_id)
...
INSERT INTO location_review(location_id, review_id, account_id)
    VALUES(1, 1, 1);
INSERT INTO location_review(location_id, review_id, account_id)
    VALUES(2, 2, 2);
INSERT INTO location_review(location_id, review_id, account_id)
